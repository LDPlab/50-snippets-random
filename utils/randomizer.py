...
def get_50_ordered_snippets(data: pd.DataFrame, is_tvn: bool) -> pd.DataFrame:
    '''
    ...
    print(f"Selecting 50 ordered snippets at least +/- {TIME_FILTER_IN_SECONDS} seconds apart...")
